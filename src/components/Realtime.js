...
function Realtime() {
  return (
    <div className="bg-white  w-200 h-full filter shadow-sm pl-4 pt-2.5 flex flex-col">
      ...
      <h2 className="font-semibold text-sm mt-2.5">Total Realtime Tests:<span className="font-light pl-2 text-sm">2,394</span></h2>
       <div className="flex justify-center items-center w-full h-28 flex-col mt-5 mb-3 relative">
        <Chart  />
